...
> 💡 **Script paths are relative to `.windsurf/` directory**
...
# P0: Security Scan
python .windsurf/skills/vulnerability-scanner/scripts/security_scan.py .

# P1: UX Audit
python .windsurf/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .windsurf/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .windsurf/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
